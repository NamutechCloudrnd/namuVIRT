...
export default {
  ...
  docHelp: '#/manual/04_images/01_templates/templates.html',
  children: [
    {
      name: 'template',
    ...
    },
    {
      ...
      title: 'label.isos',
      icon: 'usb-outlined',
      docHelp: '#/manual/04_images/02_isos/isos.html',
      permission: ['listIsos'],
    ...
    },
    {
      ...
      icon: kubernetesIcon,
      docHelp: '#/manual/04_images/03_kubernetes_isos/kubernetes_isos.html',
