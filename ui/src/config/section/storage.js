  ...
  children: [
    {
      ...
      title: 'label.volumes',
      icon: 'hdd-outlined',
      docHelp: '#/manual/02_storage/01_volumes/volumes.html',
    ...
    },
    {
      ...
      title: 'label.snapshots',
      icon: 'build-outlined',
      docHelp: '#/manual/02_storage/02_volume_snapshots/volume_snapshots.html',
    ...
    },
    {
      ...
      icon: 'build-outlined',
      docHelp: '#/manual/02_storage/03_snapshot_policies/snapshot_policies.html',
    ...
    },
    {
      ...
      title: 'label.backups',
      icon: 'cloud-upload-outlined',
      docHelp: '#/manual/02_storage/04_backups/backups.html',
    ...
    },
    {
      ...
      icon: 'build-outlined',
      docHelp: '#/manual/02_storage/05_backup_schedules/backup_schedules.html',
    ...
    },
    {
      ...
      docHelp: '#/manual/02_storage/06_buckets/buckets.html',
    ...
    },
    {
      ...
      docHelp: '#/manual/02_storage/07_shared_filesystems/shared_filesystems.html',
